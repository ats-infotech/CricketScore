...
const matchSlice = createSlice({
    ...
    reducers: {
            ...
            state.data = state.data.map((item) =>
                item.id === id ? {
                    ...
                    firstInnings: {
                        ...item.firstInnings,
                        Partnerships: [
                            ...(item.firstInnings.Partnerships || []),
                            firstInnings.Partnerships,
                        ]
                    }
                } : item
            );
        ...
        RemovePartnership: (state, action) => {
            ...
            state.data = state.data.map((item) =>
                item.id === id ? {
                    ...
                    firstInnings: {
                        ...item.firstInnings,
                        Partnerships: item.firstInnings.Partnerships.filter(partnership => !(partnership.batter1Id === batter1Id && partnership.batter2Id === batter2Id))
                    }
                } : item
            );
        },
        ...
        AddSecondInningsPartnership: (state, action) => {
            const { id, secondInnings } = action.payload;
            state.data = state.data.map((item) =>
                item.id === id ? {
                    ...item,
                    secondInnings: {
                        ...item.secondInnings,
                        Partnerships: [
                            ...(item.secondInnings.Partnerships || []),
                            secondInnings.Partnerships,
                        ]
                    }
                } : item
            );
        },
        RemoveSecondInningsPartnership: (state, action) => {
            const { id, batter1Id, batter2Id } = action.payload;
            state.data = state.data.map((item) =>
                item.id === id ? {
                    ...item,
        ...
        AddSuperOverShots: (state, action) => {
            const { id, superOverFirstInnings } = action.payload;
            state.data = state.data.map((item) =>
                item.id === id ? {
                    ...item,
                    superOverFirstInnings: {
                        ...item.superOverFirstInnings,
                        Shots: [
                            ...(item.superOverFirstInnings.Shots || []),
                            superOverFirstInnings.Shots,
                        ]
                    }
                } : item
            );
        ...
        AddSuperOverSecondInningsShots: (state, action) => {
            const { id, superOverSecondInnings } = action.payload;
            state.data = state.data.map((item) =>
                item.id === id ? {
                    ...item,
                    superOverSecondInnings: {
                        ...item.superOverSecondInnings,
                        Shots: [
                            ...(item.superOverSecondInnings.Shots || []),
                            superOverSecondInnings.Shots,
                        ]
                    }
                } : item
            );
...
export const { createMatchSchedule, editMatchSchedule, deleteMatchSchedule, deleteAllMatchesForTournament, autoMatchSchedule, ReplaceMatchSchedule, AddInnings, AddOver, ChangeMatchOver, ChangeMatchTarget,
    ...
    RemoveSuperOverSecondInningsPartnership, ChangeWagonWheelChoice, AddShots, AddSecondInningsShots, AddSuperOverShots, AddSuperOverSecondInningsShots } = matchSlice.actions
