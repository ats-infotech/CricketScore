...
const CACHE_FILE = path.resolve('./.cache/cricket/liveMatches.json');
...
export async function GET(req) {
  try {
    ...
    // Fetch fresh data
    const response = await apiRequest('GET', apiRoutes.CRICKET.MATCHES, {
      status: 3,
      per_paged: 50
    }, {
      'x-rapidapi-key': process.env.NEXT_PUBLIC_CRICKET_TEST_DEV_KEY,
