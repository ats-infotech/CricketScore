...
const CACHE_FILE = path.resolve('./.cache/football/englandAndFranceUpcomingMatches.json');
...
const getUpcomingDatePairs = () => {
  ...
  for (let i = 0; i < 6; i++) {
    ...
    fromDate.setDate(today.getDate() + i);
...
export async function GET(req, { params }) {
  ...
  const pastDates = getUpcomingDatePairs();
