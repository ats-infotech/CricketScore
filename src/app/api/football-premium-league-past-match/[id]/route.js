...
const CACHE_FILE = path.resolve('./.cache/football/premiumLeaguePastMatchData.json');
...
export async function GET(req, context) {
    ...
    try {
        ...
        const response = await apiRequest(
            'GET',
            `${apiRoutes.FOOTBALL.FOOTBALL}/?met=Fixtures&APIkey=${process.env.NEXT_PUBLIC_FOOTBALL_LEAGUE_KEY}&matchId=${id}&timezone=Asia/Kolkata`,
            '',
            '',
            '',
