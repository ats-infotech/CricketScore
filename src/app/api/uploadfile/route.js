...
export async function POST(req) {
    try {
        ...
        const thumbnailUrl = join('uploads', `tournament${folderId}`, subFolder, `${Date.now()}-${thumbnail.name}`);
...
export async function PUT(req) {
    try {
        ...
        const oldFilePath = join(process.cwd(), 'public', 'uploads', `tournament${folderId}`, subFolder, oldFileName);
        ...
        const thumbnailUrl = join('uploads', `tournament${folderId}`, subFolder, newFileName);
        const filePath = join(process.cwd(), 'public', thumbnailUrl);
...
export async function DELETE(req) {
    try {
        ...
        const filePath = join(process.cwd(), 'public', 'uploads', `tournament${folderId}`, subFolder, fileName);
        const subFolderPath = join(process.cwd(), 'public', 'uploads', `tournament${folderId}`, subFolder);
