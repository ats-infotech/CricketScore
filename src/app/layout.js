...
export default function RootLayout({ children }) {
  ...
  const UpdatePath = () => {
    ...
    const pathsToHideFooter = ['/toss', '/player11', '/scoreboard', '/playerboard', '/players', '/creatematch', '/automatchschedule', '/registeredTornaments', '/edit-match', '/edit-tournament', '/teams/'];
